      ...
      public int GetNewNumber()
        ...
        public void AdaptiveNextGenerations(int amount)
        {
            ...
            for(int i = 0 ; i < amount; i++)
            {
                ...
                if (seriesnumber % MutationChangeInterval == 0 && ChangingMutationEbaled)
                {
                ...
                if(seriesnumber % EtylistChangeInterval == 0 && ElitistRate > 4 && EtylistRateEnabled)
                {
        ...
        public void GenerateNextGeneration(int option)
        {
            ...
            Console.WriteLine(seriesnumber);
            seriesnumber++;
